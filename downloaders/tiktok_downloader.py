...
class TikTokDownloader(BaseDownloader):
    """
    وحدة تحميل الوسائط من TikTok
    """
    
    async def download(self, url, download_folder):
        """
        تحميل الوسائط من رابط TikTok
        ...
        try:
            ...
            temp_filename = self._generate_temp_filename("tiktok", ".mp4", download_folder)
            
            # استخدام yt-dlp لتحميل الفيديو بدون علامة مائية
            download_cmd = [
                "yt-dlp",
                "--no-warnings",
                "--quiet",
